 ...
 */
public class RewriteFilter extends io.linlan.doc.common.filter.AbstractUrlMatcher implements Filter {
    ...
    public void init(FilterConfig cfg) throws ServletException {
        ...
        if (io.linlan.doc.common.util.StringUtil.isNotEmpty(exceptUrlString)) {
