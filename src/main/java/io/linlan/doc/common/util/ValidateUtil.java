...
public class ValidateUtil {
    ...
    public static boolean validate(String str, String pattern) {
        return io.linlan.doc.common.util.StringUtil.isNotEmpty(str) && str.matches(pattern);
    }
    ...
    public static boolean isIP(String ip) {
        if (io.linlan.doc.common.util.StringUtil.isEmpty(ip)) {
            return false;
        } else {
            ip = ip.toLowerCase();
    ...
    public static boolean isContainsForbiddenCharacter(String number) {
        if (io.linlan.doc.common.util.StringUtil.isEmpty(number)) {
            return false;
        } else {
    ...
    public static boolean isContainsChinese(String str) {
        if (io.linlan.doc.common.util.StringUtil.isEmpty(str)) {
            return true;
        }
