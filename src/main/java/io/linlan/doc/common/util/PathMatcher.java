...
public class PathMatcher {
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch) {
        ...
        String[] pattDirs = io.linlan.doc.common.util.StringUtil.tokenizeToStringArray(pattern, this.pathSeparator, false, true);
        String[] pathDirs = io.linlan.doc.common.util.StringUtil.tokenizeToStringArray(path, this.pathSeparator, false, true);
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = io.linlan.doc.common.util.StringUtil.tokenizeToStringArray(pattern, this.pathSeparator, false, true);
        String[] pathParts = io.linlan.doc.common.util.StringUtil.tokenizeToStringArray(path, this.pathSeparator, false, true);
