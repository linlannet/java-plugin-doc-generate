...
import io.linlan.doc.common.net.SSLSocketFactoryBuilder;
import io.linlan.doc.common.net.TrustAnyTrustManager;
import okhttp3.*;
...
public class OkHttp3Util {
    ...
    public static void asyncGet(OkHttpClient client, String baseUrl, Map<String, String> params, Map<String, String> headersMap,
                                Callback callback) {
        String url = io.linlan.doc.common.util.UrlUtil.urlJoin(baseUrl, params);
