...
import io.linlan.doc.common.util.ValidateUtil;
...
public class DocUtil {
    ...
    //private static Faker faker = new Faker(new Locale("doc-generate_language"));
    ...
    static {
        ...
        fieldValue.put("id-string", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(1, 200)));
        ...
        fieldValue.put("age-int", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 70)));
        fieldValue.put("age-integer", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 70)));
        ...
        fieldValue.put("timestamp-string", io.linlan.doc.common.util.DateTimeUtil.dateToStr(new Date(), io.linlan.doc.common.util.DateTimeUtil.DATE_FORMAT_SECOND));
        fieldValue.put("time-long", String.valueOf(System.currentTimeMillis()));
        fieldValue.put("time-string", io.linlan.doc.common.util.DateTimeUtil.dateToStr(new Date(), io.linlan.doc.common.util.DateTimeUtil.DATE_FORMAT_SECOND));
        fieldValue.put("birthday-string", io.linlan.doc.common.util.DateTimeUtil.dateToStr(new Date(), io.linlan.doc.common.util.DateTimeUtil.DATE_FORMAT_DAY));
        fieldValue.put("birthday-long", String.valueOf(System.currentTimeMillis()));
        fieldValue.put("code-string", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(100, 99999)));
        fieldValue.put("message-string", "success,fail".split(",")[io.linlan.doc.common.util.RandomUtil.randomInt(0, 1)]);
        fieldValue.put("date-string", io.linlan.doc.common.util.DateTimeUtil.dateToStr(new Date(), io.linlan.doc.common.util.DateTimeUtil.DATE_FORMAT_DAY));
        fieldValue.put("date-date", io.linlan.doc.common.util.DateTimeUtil.dateToStr(new Date(), io.linlan.doc.common.util.DateTimeUtil.DATE_FORMAT_DAY));
        fieldValue.put("begintime-date", io.linlan.doc.common.util.DateTimeUtil.dateToStr(new Date(), io.linlan.doc.common.util.DateTimeUtil.DATE_FORMAT_DAY));
        fieldValue.put("endtime-date", io.linlan.doc.common.util.DateTimeUtil.dateToStr(new Date(), io.linlan.doc.common.util.DateTimeUtil.DATE_FORMAT_DAY));
        fieldValue.put("time-localtime", io.linlan.doc.common.util.DateTimeUtil.long2Str(System.currentTimeMillis(), io.linlan.doc.common.util.DateTimeUtil.DATE_FORMAT_SECOND));
        fieldValue.put("state-int", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 10)));
        fieldValue.put("state-integer", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 10)));
        fieldValue.put("flag-int", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 10)));
        fieldValue.put("flag-integer", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 10)));
        fieldValue.put("flag-boolean", "true");
        fieldValue.put("flag-Boolean", "false");
        fieldValue.put("idcard-string", io.linlan.doc.common.util.IDCardUtil.getIdCard());
        fieldValue.put("sex-int", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 2)));
        fieldValue.put("sex-integer", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 2)));
        fieldValue.put("gender-int", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 2)));
        fieldValue.put("gender-integer", String.valueOf(io.linlan.doc.common.util.RandomUtil.randomInt(0, 2)));
    ...
    public static String jsonValueByType(String typeName) {
        ...
        String value = io.linlan.doc.common.util.RandomUtil.randomValueByType(type);
    ...
    public static boolean isClassName(String className) {
        ...
        if (io.linlan.doc.common.util.ValidateUtil.isContainsChinese(className)) {
            return false;
        }
    ...
    public static boolean isMatch(String packageFilters, String controllerName) {
        if (StringUtils.isEmpty(packageFilters)) {
            return false;
        }
    ...
    public static String handleMappingValue(JavaAnnotation annotation) {
        ...
        if (StringUtils.isEmpty(url)) {
            ...
            return StringUtilsExt.trimBlank(url);
        }
    }
    ...
    public static Map<String, String> getParamsComments(final JavaMethod javaMethod, final String tagName, final String className) {
        ...
        for (DocletTag docletTag : paramTags) {
            ...
            if (StringUtils.isEmpty(value) && StringUtils.isNotEmpty(className)) {
    ...
    public static Map<String, String> getFieldTagsValue(final JavaField field, DocJavaField docJavaField) {
        ...
        if (io.linlan.doc.common.util.CollectionUtil.isEmpty(paramTags) && Objects.nonNull(docJavaField)) {
    ...
    public static String handleRequestHeaderValue(JavaAnnotation annotation) {
        ...
        return StringUtilsExt.trimBlank(header);
    ...
    public static List<ApiErrorCode> errorCodeDictToList(ApiConfig config) {
        if (io.linlan.doc.common.util.CollectionUtil.isNotEmpty(config.getErrorCodes())) {
            return config.getErrorCodes();
        }
        List<ApiErrorCodeDictionary> errorCodeDictionaries = config.getErrorCodeDictionaries();
        if (io.linlan.doc.common.util.CollectionUtil.isEmpty(errorCodeDictionaries)) {
            ...
            try {
                for (ApiErrorCodeDictionary dictionary : errorCodeDictionaries) {
                    ...
                    if (Objects.isNull(clzz)) {
                        if (StringUtils.isEmpty(dictionary.getEnumClassName())) {
                            throw new RuntimeException("Enum class name can't be null.");
                        }
                        clzz = Class.forName(dictionary.getEnumClassName());
                    }
                    List<ApiErrorCode> enumDictionaryList = io.linlan.doc.common.util.EnumUtil.getEnumInformation(clzz, dictionary.getCodeField(),
    ...
    public static List<ApiDocDict> buildDictionary(ApiConfig config, JavaProjectBuilder javaProjectBuilder) {
        ...
        if (io.linlan.doc.common.util.CollectionUtil.isEmpty(apiDataDictionaryList)) {
            return new ArrayList<>(0);
        }
        ...
        try {
            ...
            for (ApiDataDictionary apiDataDictionary : apiDataDictionaryList) {
                ...
                if (Objects.isNull(clazz)) {
                    if (StringUtils.isEmpty(apiDataDictionary.getEnumClassName())) {
                        throw new RuntimeException("Enum class name can't be null.");
                    }
                ...
                List<DataDict> enumDictionaryList = io.linlan.doc.common.util.EnumUtil.getEnumInformation(clazz, apiDataDictionary.getCodeField(),
    ...
    public static String formatFieldTypeGicName(Map<String, String> genericMap, String[] globGicName, String fieldGicName) {
        ...
        if (gNameArr.length > 0) {
            ...
            if (gName.length() == 1) {
                ...
                if (StringUtils.isNotEmpty(gicName)) {
