 ...
 */
package net.linlan.plugin.util;
...
public class MojoUtils {
     ...
     */
    public static ApiConfig buildConfig(File configFile, String projectName,
        ...
        try {
            ...
            if (Objects.nonNull(responseBodyAdvice) && StringUtils.isNotEmpty(responseBodyAdvice.getClassName())) {
                responseBodyAdvice.setWrapperClass(getClassByClassName(responseBodyAdvice.getClassName(), classLoader));
            }
            if (Objects.nonNull(requestBodyAdvice) && StringUtils.isNotEmpty(requestBodyAdvice.getClassName())) {
    ...
    private static void addSourcePaths(MavenProject project, ProjectBuilder projectBuilder, MavenSession mavenSession, ApiConfig apiConfig, List<String> projectArtifacts, Log log) {
        ...
        sourceCodePaths.add(SourceCodePath.builder()
                .setPath(project.getBasedir() + GlobalConstants.FILE_SEPARATOR + GlobalConstants.SOURCE_CODE_PATH));
        ...
        log.info("Doc Generate has loaded the source code path: " + GSON.toJson(sourceCodePaths)
    ...
    private static void buildModules(MavenProject project, ProjectBuilder projectBuilder, MavenSession mavenSession, Map<String, String> moduleList, Log log) {
        ...
        for (Map.Entry<String, MavenProject> mavenProject : referenceMavenProject.entrySet()) {
            ...
            moduleList.put(groupId + ":" + artifactId, mavenProject.getValue().getBasedir() + GlobalConstants.FILE_SEPARATOR + GlobalConstants.SOURCE_CODE_PATH);
        }
    }
     ...
     * @return               Map
     */
    public static Map<String, MavenProject> collectProject(MavenProject project, ProjectBuilder projectBuilder,
