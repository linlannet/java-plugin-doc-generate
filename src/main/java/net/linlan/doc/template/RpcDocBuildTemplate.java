...
import net.linlan.doc.constants.DubboAnnotationConstants;
import net.linlan.doc.helper.ParamsBuildHelper;
import net.linlan.doc.model.ApiConfig;
import net.linlan.doc.model.ApiParam;
import net.linlan.doc.model.DocJavaMethod;
import net.linlan.doc.model.JavaMethodDoc;
...
import static net.linlan.doc.constants.DocTags.DEPRECATED;
import static net.linlan.doc.constants.DocTags.IGNORE;
...
public class RpcDocBuildTemplate implements IDocBuildTemplate<RpcApiDoc> {
    ...
    private void handleJavaApiDoc(JavaClass cls, List<RpcApiDoc> apiDocList, List<JavaMethodDoc> apiMethodDocs,
        ...
        if (javaTypes.size() >= 1 && !cls.isInterface()) {
            ...
            if (StringUtils.isEmpty(comment) && Objects.nonNull(javaClass)) {
