...
public enum FrameworkEnum {
     ...
     * Apache Dubbo
     */
    DUBBO("dubbo", "net.linlan.doc.template.RpcDocBuildTemplate"),

    /**
     * Spring Framework
     */
    SPRING("spring", "net.linlan.doc.template.SpringBootDocBuildTemplate"),

    /**
     * JAX-RS
     */
    JAX_RS("JAX-RS", "net.linlan.doc.template.JaxrsDocBuildTemplate");
