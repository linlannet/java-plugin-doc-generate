...
import net.linlan.doc.constants.DocLanguage;
import net.linlan.doc.constants.FrameworkEnum;
import net.linlan.doc.constants.TemplateVariable;
import net.linlan.doc.model.ApiConfig;
import net.linlan.doc.model.RevisionLog;
...
public class BaseDocBuilderTemplate {
    ...
    public void checkAndInit(ApiConfig config, boolean checkOutPath) {
        ...
        if (StringUtils.isEmpty(config.getOutPath())&&!checkOutPath) {
        ...
        if (Objects.isNull(config.getRevisionLogs())) {
            ...
            config.setRevisionLogs(
                    RevisionLog.builder()
                            ...
                            .setRemarks("Created by doc-generate")
                            .setStatus("auto")
            );
        }
    ...
    public String allInOneDocName(ApiConfig apiConfig, String fileName, String suffix) {
        ...
        } else if (StringUtils.isNotEmpty(fileName) && fileName.endsWith(suffix)) {
            return fileName;
        } else {
