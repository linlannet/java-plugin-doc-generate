...
2.3.0           2021-11-05    基于smart-doc工程初始化
...
- 更新日期: 2021-08-08
- 更新内容：
    1. 修复字典码推送torna错误 #https://gitee.com/linlanio/ll-plugin-doc-generate/issues/I43JQR。
...
- 更新内容：
    ...
    5. 修复dubbo rpc文档模板格式错误 #https://gitee.com/linlanio/ll-plugin-doc-generate/issues/I40ZGE .
    6. 支持配置添加拦截器中设置全局请求参数，#https://github.com/linlanio/ll-plugin-doc-generate/issues/132 .
...
- 更新内容：
    ...
    7. 移除YapiBuilder。doc-generate不在支持其他第三方接口系统，请使用torna.
#### 版本号：2.1.9
...
- 更新内容：
    ...
    3. doc-generate使用的css cdn更换，默认使用国内cdn，提升国内的加载速度，切换英文环境使用google的cdn.
...
- 更新内容：
    ...
    4. 增加泛型实际类型的显示开关控制。
    5. 修复类继承一个泛型类时的解析错误。
    6. 优化doc-generate maven插件，提升用户在多模块下的使用体验。
...
- 更新内容：
    ...
    3. 修改doc-generate的beetl配置避免和用户的业务中beetl配置冲突。
...
- 更新内容：
    ...
    2. 修改doc-generate-maven-plugin生成dubbo文档时缺乏配置文件错误问题。
...
- 更新日期: 2020-05-09
- 更新内容：
    1. 增加localTime支持[gitee #I1F7CW](https://gitee.com/sunyurepository/doc-generate/issues/I1F7CW)。
    2. 优化doc-generate导入Postman
    ...
    5. 修复通用泛型解析出错[git #28](https://github.com/linlanio/ll-plugin-doc-generate/issues/28)。

#### 版本号：1.8.5

- 更新日期: 2020-04-19
- 更新内容：
    1. maven插件错误码列表导出bug[git #I1EHXA](https://gitee.com/sunyurepository/doc-generate/issues/I1EHXA)。
    2. 增加@PatchMapping支持[gitee #I1EDRF](https://gitee.com/sunyurepository/doc-generate/issues/I1EDRF)
    3. 解决javadoc包含重复tag生成文档报错[gitee #I1ENNM](https://gitee.com/sunyurepository/doc-generate/issues/I1ENNM)。
    4. 修改当请求参数为泛型时数据解析错误问题。
    5. 修复分组验证空指针问题，不对返回对象做分组验证处理。
    6. 优化doc-generate-maven-plugin对多级maven项目的加载。
...
- 更新内容：
    1. Controller新增时候@ignore
       tag,可适应该tag忽略不需要生成文档的controller[git #24](https://github.com/linlanio/ll-plugin-doc-generate/issues/24)。
...
- 更新内容：
    ...
    2. 修改doc-generate默认编码为utf-8，解决生成文档乱码问题。
...
- 更新内容：
    ...
    3. 新增ApiDataBuilder用于获取doc-generate生成的文档数据，包含header、字典、错误码等。
    4. 合并fork分支的github book html5模板，新增搜索和锚点。
    5. 新增自定义@mock tag用于指定生成文档的字段值，@param 的参数注释增加mock值的功能(@param name 姓名|张三)
    6. 重点：doc-generate的maven插件doc-generate-maven-plugin增强对maven标准项目的支持。
...
- 更新内容：
    ...
    6. 重点：doc-generate的maven插件doc-generate-maven-plugin 1.0.0版本发布。
...
- 更新内容：
    ...
    2. 增强时间字段的mock数据创建
    3. 修改doc-generate解析自引用对象出错的bug

#### 版本号：1.0

- 更新日期：2018-08-25
- 更新内容：
    1. doc-generate增加将所有文档导出归档到一个markdown中件的功能
...
- 更新日期：2018-08-23
- 更新内容：
    1. 将api-doc重命名为doc-generate并发布到中央仓库
